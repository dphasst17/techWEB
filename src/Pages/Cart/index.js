...
const Cart = () => {
  ...
  const {paymentList,setPaymentList,isDark} = useContext(StateContext);
    ...
    <div className="w-full h-auto min-h-[900px] bg-transparent pt-20">
      ...
      <div className="w-4/5 mx-auto justify-center px-6 xl:flex xl:space-x-6 xl:px-0">
        <div className="rounded-lg xl:w-2/3 flex flex-wrap">
          {cartItems !== null &&
            cartItems?.map((e) => (
              <div className="w-full 2xl:w-[48%] h-auto md:h-[100px] justify-center sm:justify-between items-center p-2 mb-6 mx-2 rounded-lg bg-white shadow-md sm:flex sm:justify-start">
                <img
                  src={e.imgProduct}
                  alt="product-img"
                  className="w-full h-[100px] md:h-full object-contain rounded-lg sm:w-40"
                />
                <div className="h-auto sm:h-full xl:ml-4 flex flex-wrap w-full justify-center lg:justify-between">
                  <div className="w-full sm:w-3/5 flex flex-col justify-between mt-5 sm:mt-0 overflow-hidden whitespace-nowrap text-ellipsis">
                  ...
                  <div className="w-full sm:w-2/5 lg:w-[30%] 2xl:w-2/5 h-[50px] sm:h-full flex my-4 md:my-0 sm:flex-col justify-around">
                    <div className="w-2/5 sm:w-full flex items-center border-gray-100">
                      <span
                        onClick={() => {
                    ...
                    <div className="w-2/5 sm:w-full flex flex-wrap items-center">
