            ...
            <div className={cx("container")}>
                <div className={cx("content")}>
                        ...
                        <div className={cx("container")}>
                            ...
                            {keyword.map((price, index) =>(                    
                                <div className={cx("content")} key={index}>
                                    <div className={cx("detail")}>
                                        <input type="checkbox" name="keyword"></input>
                                        <label for="keyword">{price.price}</label>
                                    </div>
                                </div>
                            ))}
                        </div>
                    ...
                    <div className={cx("button")}>
                        <button className={cx("next")}><FontAwesomeIcon icon={faAnglesLeft} /></button>
                        <button className={cx("prev")}><FontAwesomeIcon icon={faAnglesRight} /></button>
