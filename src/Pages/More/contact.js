const Contact = () => {
    return <section className="min-h-[500px] lg:flex">
        ...
        <form>
            <div className="-mx-2 md:items-center md:flex">
                <div className="flex-1 px-2">
                    <label className="block mb-2 text-sm text-gray-900 font-semibold">Full Name</label>
                ...
                <div className="flex-1 px-2 mt-4 md:mt-0">
                    <label className="block mb-2 text-sm text-gray-900 font-semibold">Email address</label>
            ...
            <div className="w-full mt-4">
                <label className="block mb-2 text-sm text-gray-900 font-semibold">Message</label>
