const Contact = () => {
    return <section className="w-full" id="contact">
    <div className="mx-auto w-4/5 px-4 py-16 sm:px-6 lg:px-8 lg:py-20">
        <div className="mb-4">
            <div className="mb-6 max-w-3xl text-center sm:text-center md:mx-auto md:mb-12">
                <p className="text-[25px] font-bold uppercase tracking-wide text-blue-600">
                    Contact
                </p>
                <h2
                ...
                <p className="mx-auto mt-4 max-w-3xl text-xl text-gray-900 ">In hac habitasse platea
                    dictumst
                </p>
            </div>
        </div>
                    ...
                    <ul className="mb-6 md:mb-0">
                        <li className="flex">
                            ...
                            <div className="ml-4 mb-4">
                                <h3 className="mb-2 text-lg font-semibold leading-6 text-gray-900 ">Our Address
                                </h3>
                                <p className="text-gray-900 ">1230 Maecenas Street Donec Road</p>
                                <p className="text-gray-900 ">New York, EEUU</p>
                            </div>
                        </li>
                        <li className="flex">
                            <div className="flex h-10 w-10 items-center justify-center rounded bg-blue-900 text-gray-50">
                            ...
                            <div className="ml-4 mb-4">
                                ...
                                <p className="text-gray-900 ">Mobile: +1 (123) 456-7890</p>
                                <p className="text-gray-900 ">Mail: tailnext@gmail.com</p>
                            </div>
                        </li>
                        <li className="flex">
                            <div className="flex h-10 w-10 items-center justify-center rounded bg-blue-900 text-gray-50">
                            ...
                            <div className="ml-4 mb-4">
                                <h3 className="mb-2 text-lg font-semibold leading-6 text-gray-900 ">Working
                                    hours</h3>
                                <p className="text-gray-900 ">Monday - Friday: 08:00 - 17:00</p>
                                <p className="text-gray-900 ">Saturday &amp; Sunday: 08:00 - 12:00</p>
                            </div>
                        </li>
                    </ul>
                </div>
